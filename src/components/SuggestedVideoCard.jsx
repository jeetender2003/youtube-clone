        ...
        <div className="flex flex-col ml-3 overflow-hidden">
            ...
            <span className="text-[12px] lg:text-[10px] xl:text-[12px] font-semibold mt-2 text-white/[0.7]  flex items-center">
              ...
              {video?.author?.badges[0]?.type === "VERIFIED_CHANNEL" && (
                <BsFillCheckCircleFill className="ml-1 text-white/[0.5] text-[12px] lg:text-[10px] xl:text-[12px]" />
              )}
            </span>
            <div className="flex text-[12px] lg:text-[10px] xl:text-[12px] text-white/[0.7] font-semibold truncate overflow-hidden">
